 ...
 *
 * <p>Обёртка вида {@code {"data": {...}}}, где полезная нагрузка лежит в {@link PlanData}.
 * Этот же DTO используется в Swagger-схеме контроллера в качестве описания 200-ответа.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class PlanBuildResponse {
    ...
    public static class PlanData {
        ...
        @Schema(
                description =
                        "Сколько перестановок порядка посещения было проверено алгоритмом",
                example = "120")
    ...
    public static class PlanItem {
        ...
        @Schema(
                description = "Сколько минут заняла дорога от предыдущей точки",
                example = "15")
