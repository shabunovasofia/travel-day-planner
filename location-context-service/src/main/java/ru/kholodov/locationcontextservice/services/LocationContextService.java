 ...
 *
 * <p>Отвечает за получение координат по текстовому адресу (пока заглушка) и формирование итогового
 * ответа с помощью фабричного метода.
 */
@Service
public class LocationContextService {
   ...
   *
   * <p>На текущем этапе геокодирование эмулируется константными координатами для адреса "Арбат,
   * Москва". В будущем будет заменено на вызов внешнего API.
   *
