 ...
 *
 * <p>Использует потокобезопасный кэш {@code ConcurrentHashMap} для снижения
 * количества внешних запросов. Возвращает координаты или пустой Optional,
 * если адрес не найден или произошла ошибка.
 */
@Service
public class GeocodingService {
    ...
    private Optional<Coordinates> geocodeUncached(String address) {
        try {
            ...
            URI uri =
                    UriComponentsBuilder.fromHttpUrl(geocodingUrl)
            ...
            logger.debug("Geocoding request: q={}", address);
