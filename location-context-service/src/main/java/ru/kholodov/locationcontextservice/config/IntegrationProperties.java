 ...
 *
 * <p>Содержит базовые URL для вызова {@code places-service} и {@code planner-service}.
 * Значения читаются из {@code application.properties} с префиксом {@code integration}.
 */
@Getter
@Setter
@Validated
